...
export const useWalletsStore = defineStore('wallets', {
  ...
  actions: {
    ...
    performTransaction(id: string, operation: TransactionOperation, amount: number, timestamp?: Date): TransactionRecord {
    ...
    commitPendingTransactions(walletId: string) {
      ...
      const pendingTransactions = this.pendingTransactions.filter(
